<template>
    <div>
        ...
        element-loading-background="rgba(0, 0, 0, 0.8)" border>
            ...
            <el-table-column label="调账人" prop="creator"></el-table-column>
            <el-table-column label="调账金额" prop="amount"></el-table-column>
            <el-table-column label="调账时间" prop="create_time">
            ...
            <el-table-column label="调账原因" prop="reason">
                <template slot-scope="scope">
    ...
    export default {
        ...
        methods:{
            ...
            getTableList(){
                ...
                this.$http.get(this.$api.platform.accountAdjustList,{params:params}).then(res=>{
                    if(res.data.code===0){
