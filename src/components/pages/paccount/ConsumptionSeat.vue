<template>
    <div>
        ...
        element-loading-background="rgba(0, 0, 0, 0.8)" border>
            ...
            <el-table-column label="坐席" prop="creator"></el-table-column>
            <el-table-column label="申请人" prop="creator"></el-table-column>
            <el-table-column label="扣费时间" prop="amount"></el-table-column>
            <el-table-column label="金额(元)" prop="time">
            ...
            <el-table-column label="申请时间" prop="reason">
                <template slot-scope="scope">
